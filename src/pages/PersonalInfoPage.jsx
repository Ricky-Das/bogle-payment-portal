        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Required for identity verification. Your information is encrypted
              and secure.
            </p>
          </div>
        </div>
          ...
          <div className="flex items-start">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <p>
                  Federal law requires us to verify your identity before
                  processing payments. All information is encrypted and used
