...
const IdentityVerificationPage = () => {
  ...
  const handleCreateIdentity = async () => {
    ...
    try {
      ...
      // Legacy identity creation removed. Simulate success and continue.
      const response = { identityId: "legacy-removed" };
    ...
    <div className="max-w-2xl mx-auto">
      ...
      <div className="max-w-md mx-auto bg-white rounded-xl shadow p-8 space-y-6">
            ...
            <div className="ml-3">
              ...
              <div className="mt-2 text-sm text-blue-700">
                <ul className="list-disc list-inside space-y-1">
                  <li>
                    We'll verify your identity with our secure payment processor
                  </li>
                  <li>This process is instant and uses bank-level security</li>
                  <li>
                    Your information is encrypted and never stored on our
                    servers
                  </li>
                  <li>
                    Once verified, you can link your bank account securely
                  </li>
                </ul>
              </div>
            </div>
        ...
        <div className="text-center">
          <button
            onClick={() =>
              navigate("/personal-info", { state: { phone, orderDetails } })
            }
